...
def rgba2hsla(rgba):
    ...
    hsla  = np.apply_along_axis(__row_func, 1, np.column_stack((c_max,
                                                                delta,
                                                                rgba,
                                                                sat,
                                                                lightness,
...
def hsla2rgba(hsla):
    ...
    ht_r = __calc_hue(h_div, 0, l, a)
    ht_g = __calc_hue(h_div, 8, l, a)
    ht_b = __calc_hue(h_div, 4, l, a)
